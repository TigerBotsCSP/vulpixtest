...
public class Drive {
    ...
    public final Module m_frontLeft = new Module(1, 2);
    public final Module m_frontRight = new Module(3, 4);
    public final Module m_backLeft = new Module(5, 6);
    public final Module m_backRight = new Module(7, 8);
    ...
    // ! Change the values!
    // TODO: Editing the translation on SmartDashboard will not work...make it work?
    private final Translation2d m_frontLeftLocation = new Translation2d(RobotContainer.translation, RobotContainer.translation);
    private final Translation2d m_frontRightLocation = new Translation2d(RobotContainer.translation, -RobotContainer.translation);
    private final Translation2d m_backLeftLocation = new Translation2d(-RobotContainer.translation, RobotContainer.translation);
    private final Translation2d m_backRightLocation = new Translation2d(-RobotContainer.translation, -RobotContainer.translation);
